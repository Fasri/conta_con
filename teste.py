def extract_report_tempo_real():
    ...
    fp.set_preference("browser.download.dir", r"/home/felipe-ribeiro/Projetos/contadoria/data_tempo_real")  # Substitua pelo caminho da sua pasta
...
def transform_tempo_real():
    ...
    list_of_files = glob.glob('/home/felipe-ribeiro/Projetos/contadoria/data_tempo_real/*.xlsx')
    ...
    df_selected["vazio"] = "" # Criar uma nova coluna vazia

    df_selected = df_selected[["nucleo","processo","vara","data","vazio","prioridades","dias"]] # Reorganizar as colunas
    ...
    file_path1 = 'Consolidado.xlsx'
   
    with pd.ExcelWriter(file_path1) as writer:
        consolidado.to_excel(writer, sheet_name='CONSOLIDADO', index=False)
    shutil.move(file_path1, '/home/felipe-ribeiro/Projetos/contadoria/data_transform/' + file_path1)
    print('Copiado para data_transform')
    ...
    shutil.move(divided_file_path, '/home/felipe-ribeiro/Projetos/contadoria/data_transform/' + divided_file_path)
...
def load_tempo_real():
    ...
    SERVICE_ACCOUNT_FILE = '/home/felipe-ribeiro/Projetos/contadoria/credentials.json'  # Caminho para o seu arquivo credentials.json
    ...
    file_path = '/home/felipe-ribeiro/Projetos/contadoria/data_transform/final_tempo_real.xlsx'
